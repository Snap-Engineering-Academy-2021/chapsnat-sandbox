      ...
      >
        ...
        <Marker
          onPress={() => {
            ...
            top.value = withSpring(dimensions.height / 5, SPRING_CONFIG);
          }}
          coordinate={{
        ...
        <>
          <View style={{ position: "absolute", left: 0, top: 0 }}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setBitmojiFrame(bitmojiFrame + 1);
        ...
        >
          <View style={{ alignItems: "center" }}>
            ...
            <View style={{ flexDirection: "row", marginTop: 5 }}>
              ...
              <TouchableOpacity
                style={[styles.smallButtonContainer, styles.shadowEffect]}
              >
